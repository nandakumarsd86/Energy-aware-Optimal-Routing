...
function [Top_gazelle_fit,Top_gazelle_pos,Convergence_curve, time]=GOA(gazelle,fobj,lb,ub,Max_iter)

[SearchAgents_no , dim] = size(gazelle);
...
while Iter<Max_iter    
 ...
 for i=1:size(gazelle,1)  
    ...
    fitness(i,1)=feval(fobj, gazelle(i,:));
